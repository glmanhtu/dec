...
device_id: 0""".format(rate, params['step'][0], params['pt_iter'][0], params['decay'][0], db))
        ...
        os.system('caffe train --solver=pt_solver.prototxt --weights=stack_init.caffemodel -gpu=' + str(dec.get_gpu()))
...
if __name__ == '__main__':
    ...
    os.system("caffe train --solver=ft_solver.prototxt --weights=stack_init_final.caffemodel -gpu=" + str(dec.get_gpu()))
